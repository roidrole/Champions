...
public class AffixReflecting extends AffixBase {
    ...
    public AffixReflecting() {
        ...
        if(!ConfigHandler.affix.reflecting.killingBlow) {
            MinecraftForge.EVENT_BUS.register(this);
        }
    }

    //Caps reflected damage at living.getHealth() - 1, preventing killing blows
    @SubscribeEvent
    public void onDamagedEvent(LivingDamageEvent evt) {

        if (evt.getSource().damageType.equals("reflecting")) {
