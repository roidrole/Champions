...
public class ClientUtil {
    ...
    public static void renderChampionHealth(EntityLiving living, IChampionship chp) {
        ...
        chp.getAffixes().stream().forEach(ordinal -> {
            builder.append(I18n.format(Champions.MODID + ".affix." + EnumAffix.getAffix(ordinal).name().toLowerCase()));
            builder.append(" ");
        });
    ...
    public static RayTraceResult rayTraceBlocks(World world, Vec3d vec31, Vec3d vec32,
        ...
        if (Double.isNaN(vec32.x) || Double.isNaN(vec32.y) || Double.isNaN(vec32.z)){return null;}
